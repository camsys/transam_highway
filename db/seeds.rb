...
# 6XX elements
{number: 600, is_nbe: 'Y', is_protective: 'N', mat_key: '0', long_name: 'General Remarks', quantity_unit: 'each', description: 'This element is used for general remarks about the bridge, conditions in the general area of the bridge, history of the bridge from local property owners, etc. as well as to be used as a continuation of narratives of condition elements.', assembly_type: 'Ancillary'},
...
{number: 602, is_nbe: 'Y', is_protective: 'N', mat_key: '2', long_name: 'Steel - Painted Monotubes', quantity_unit: 'each', assembly_type: 'Ancillary'},
{number: 603, is_nbe: 'Y', is_protective: 'N', mat_key: '1', long_name: 'Steel - Unpainted Horizontal Trusses', description: '', assembly_type: 'Ancillary'},
{number: 604, is_nbe: 'Y', is_protective: 'N', mat_key: '2', long_name: 'Steel - Painted Horizontal Trusses', description: '', assembly_type: 'Ancillary'},
{number: 605, is_nbe: 'Y', is_protective: 'N', mat_key: '1', long_name: 'Steel - Unpaointed Column', description: '', assembly_type: 'Ancillary'},
{number: 606, is_nbe: 'Y', is_protective: 'N', mat_key: '2', long_name: 'Steel - Painted Column', description: '', assembly_type: 'Ancillary'},
{number: 607, is_nbe: 'Y', is_protective: 'N', mat_key: '3', long_name: 'P/S Concrete Column', description: '', assembly_type: 'Ancillary'},
{number: 608, is_nbe: 'Y', is_protective: 'N', mat_key: '4', long_name: 'Concrete - Column', description: '', assembly_type: 'Ancillary'},
{number: 609, is_nbe: 'Y', is_protective: 'N', mat_key: '4', long_name: 'Concrete Caison', description: '', assembly_type: 'Ancillary'},
...
{number: 613, is_nbe: 'Y', is_protective: 'N', mat_key: '2', long_name: 'Concrete Guard Railing Protection', description: '', assembly_type: 'Ancillary'},
{number: 614, is_nbe: 'Y', is_protective: 'N', mat_key: '1', long_name: 'Metal Guard Railing Protection', description: '', assembly_type: 'Ancillary'},
{number: 615, is_nbe: 'Y', is_protective: 'N', mat_key: '2', long_name: 'Steel - Fatigue', description: '', assembly_type: 'Ancillary'},
{number: 616, is_nbe: 'Y', is_protective: 'N', mat_key: '1', long_name: 'Steel Sign and Signal Str.-Bolted Splice Conn.-Pai', description: '', assembly_type: 'Ancillary'},
{number: 617, is_nbe: 'Y', is_protective: 'N', mat_key: '9', long_name: 'Steel Sign and Signal Str.-Bolted Splice Conn.-Unp', description: '', assembly_type: 'Ancillary'},
{number: 618, is_nbe: 'Y', is_protective: 'N', mat_key: '9', long_name: 'Steel Sign and Signal Str.-Welded. Conn.-Painted', description: '', assembly_type: 'Ancillary'},
{number: 619, is_nbe: 'Y', is_protective: 'N', mat_key: '9', long_name: 'Steel Sign and Signal Str.-Welded. Conn.-Unpainted', description: '', assembly_type: 'Ancillary'},
...
{number: 621, is_nbe: 'Y', is_protective: 'N', mat_key: '3', long_name: 'Column - Prestressed Concrete', description: 'This element defines the condition states of prestressed concrete columns.', assembly_type: 'Ancillary'},
{number: 622, is_nbe: 'Y', is_protective: 'N', mat_key: '4', long_name: 'Column - Reinforced Concrete', description: 'This element defines the condition states of mildly reinforced concrete columns.', assembly_type: 'Ancillary'},
...
{number: 650, is_nbe: 'Y', is_protective: 'N', mat_key: '6', long_name: 'Protective System - Paint', description: 'This element defines the condition of the paint protecting the metal on a structure.', assembly_type: 'Ancillary'},
{number: 651, is_nbe: 'Y', is_protective: 'N', mat_key: '6', long_name: 'Protective System - Galvanizing', description: 'This element defines the condition of the galvanized coating protecting the structure.', assembly_type: 'Ancillary'},
{number: 652, is_nbe: 'Y', is_protective: 'N', mat_key: '6', long_name: 'Protective System - Weathering Steel Patina', description: 'This element defines the condition of protective patina on a weathering steel structure.', assembly_type: 'Ancillary'},
...
{number: 690, is_nbe: 'Y', is_protective: 'N', mat_key: '9', long_name: 'Traffic Impact - Signal Mast Arm or Sign Frame', description: 'This smart flag addresses damage to signal mast arm or sign frame elements caused by traffic impact.', assembly_type: 'Ancillary'},
{number: 691, is_nbe: 'Y', is_protective: 'N', mat_key: '9', long_name: 'Traffic Impact - Poles/Columns', description: 'This smart flag addresses damage to signal poles or sign poles caused by traffic impact.', assembly_type: 'Ancillary'},
{number: 692, is_nbe: 'Y', is_protective: 'N', mat_key: '9', long_name: 'Traffic Impact - Guardrail', description: 'This smart flag addresses traffic impact damage to the guardrail system that protects signal poles and sign poles.', assembly_type: 'Ancillary'},
...
{number: 694, is_nbe: 'Y', is_protective: 'N', mat_key: '9', long_name: 'Critical Inspection Finding', description: 'This element is used to record critical inspection finding reports.', assembly_type: 'Ancillary'}
]
...
klass = table_name.classify.constantize
data.each do |row|
  x = klass.new(row.except(:is_nbe, :is_protective, :cat_key, :type_key, :mat_key, :assembly_type))
  x.is_protective = true if row[:is_protective] == 'Y'
