...
json.(defect, :object_key, :condition_state_1_quantity, :condition_state_2_quantity, :condition_state_3_quantity, :condition_state_4_quantity, :total_quantity, :notes)
