json.(element_definition, :id, :number, :long_name, :short_name, :description, :assembly_type_id, :element_material_id, :element_classification_id, :quantity_unit, :quantity_calculation, :created_at, :updated_at)
