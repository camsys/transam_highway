class ChildElementsController < TransamController
  ...
  def create
    ...
    if @child_element.save
      redirect_to @inspection, notice: 'Protective system was successfully created.'
    else
      render :new
    end
  end
  ...
  def update
    if @child_element.update(element_params)
      redirect_to @inspection, notice: 'Protective system was successfully updated.'
    else
      render :edit
    end
  end
  ...
  def destroy
    ...
    redirect_to @inspection, notice: 'Protective system was successfully destroyed.'
  end
