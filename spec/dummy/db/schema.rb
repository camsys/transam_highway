...
ActiveRecord::Schema.define(version: 2019_03_20_003537) do
  ...
  create_table "bridge_conditions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "bridges", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["bridge_posting_type_id"], name: "index_bridges_on_bridge_posting_type_id"
    t.index ["bridge_toll_type_id"], name: "index_bridges_on_bridge_toll_type_id"
    ...
    t.index ["design_load_type_id"], name: "index_bridges_on_design_load_type_id"
    t.index ["inventory_rating_method_type_id"], name: "index_bridges_on_inventory_rating_method_type_id"
    t.index ["lateral_reference_feature_below_id"], name: "index_bridges_on_lateral_reference_feature_below_id"
    ...
    t.index ["operating_rating_method_type_id"], name: "index_bridges_on_operating_rating_method_type_id"
    t.index ["service_on_type_id"], name: "index_bridges_on_service_on_type_id"
    t.index ["service_under_type_id"], name: "index_bridges_on_service_under_type_id"
    t.index ["strahnet_designation_type_id"], name: "index_bridges_on_strahnet_designation_type_id"
    t.index ["vertical_reference_feature_below_id"], name: "index_bridges_on_vertical_reference_feature_below_id"
