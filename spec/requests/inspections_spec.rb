...
RSpec.describe Api::V1::InspectionsController, type: :request do
  ...
  describe 'GET /api/v1/inspections' do
    ...
    it 'returns data' do
      ...
      expect(json['data'].keys).to match_array(['inspections', 'elements', 'defects', 'structures', 'roadways', 'bridge_conditions', 'culvert_conditions', 'images', 'documents', 'users', 'streambed_profiles', 'streambed_profile_points'])
    end
