...
RSpec.describe Api::V1::InspectionsController, type: :request do
  ...
  let!(:test_roadway) { create(:roadway,
                               highway_structure: test_bridge.highway_structure,
                               route_signing_prefix: create(:route_signing_prefix),
                               service_level_type: create(:service_level_type)
                               ) }
